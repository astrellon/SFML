...
#ifndef SFML_VERTEXBUFFER3D_HPP
#define SFML_VERTEXBUFFER3D_HPP
...
///
////////////////////////////////////////////////////////////
class SFML_GRAPHICS_API Vertex3dBuffer : public Drawable, private GlResource
{
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct a Vertex3dBuffer with a specific PrimitiveType
    ///
    ...
    ///
    ////////////////////////////////////////////////////////////
    explicit Vertex3dBuffer(PrimitiveType type);

    ////////////////////////////////////////////////////////////
    /// \brief Construct a Vertex3dBuffer with a specific usage specifier
    ///
    ...
    ///
    ////////////////////////////////////////////////////////////
    explicit Vertex3dBuffer(Usage usage);

    ////////////////////////////////////////////////////////////
    /// \brief Construct a Vertex3dBuffer with a specific PrimitiveType and usage specifier
    ///
    ...
    ///
    ////////////////////////////////////////////////////////////
    Vertex3dBuffer(PrimitiveType type, Usage usage);
    ...
    ///
    ////////////////////////////////////////////////////////////
    Vertex3dBuffer(const Vertex3dBuffer& copy);
    ...
    ///
    ////////////////////////////////////////////////////////////
    bool update(const Vertex3d* vertices);
    ...
    ///
    ////////////////////////////////////////////////////////////
    bool update(const Vertex3d* vertices, std::size_t vertexCount, unsigned int offset);
    ...
    ///
    ////////////////////////////////////////////////////////////
    bool update(const Vertex3dBuffer& vertexBuffer);
    ...
    ///
    ////////////////////////////////////////////////////////////
    Vertex3dBuffer& operator =(const Vertex3dBuffer& right);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void swap(Vertex3dBuffer& right);
    ...
    /// take effect.
    ///
    /// The default primitive type is sf::Vertex3dBuffer::Stream.
    ///
    /// \param usage Usage specifier
    ///
    ////////////////////////////////////////////////////////////
    ...
    /// mix sf::Vertex3dBuffer with OpenGL code.
    ///
    /// \code
    /// sf::Vertex3dBuffer vb1, vb2;
    /// ...
    /// sf::Vertex3dBuffer::bind(&vb1);
    /// // draw OpenGL stuff that use vb1...
    /// sf::Vertex3dBuffer::bind(&vb2);
    /// // draw OpenGL stuff that use vb2...
    /// sf::Vertex3dBuffer::bind(NULL);
    ...
    ///
    ////////////////////////////////////////////////////////////
    static void bind(const Vertex3dBuffer* vertexBuffer);
    ...
    /// any attempt to use sf::Vertex3dBuffer will fail.
    ///
...
#endif // SFML_VERTEXBUFFER3D_HPP


////////////////////////////////////////////////////////////
/// \class sf::VertexBuffer3d
/// \ingroup graphics
///
