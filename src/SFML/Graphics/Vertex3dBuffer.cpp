...
namespace
{
    ...
    GLenum usageToGlEnum(sf::Vertex3dBuffer::Usage usage)
    {
        switch (usage)
        {
            case sf::Vertex3dBuffer::Static:  return GLEXT_GL_STATIC_DRAW;
            case sf::Vertex3dBuffer::Dynamic: return GLEXT_GL_DYNAMIC_DRAW;
...
////////////////////////////////////////////////////////////
Vertex3dBuffer::Vertex3dBuffer(PrimitiveType type) :
m_buffer       (0),
m_size         (0),
...
////////////////////////////////////////////////////////////
Vertex3dBuffer::Vertex3dBuffer(Vertex3dBuffer::Usage usage) :
m_buffer       (0),
m_size         (0),
m_primitiveType(Points),
m_usage        (usage)
...
////////////////////////////////////////////////////////////
Vertex3dBuffer::Vertex3dBuffer(PrimitiveType type, Vertex3dBuffer::Usage usage) :
m_buffer       (0),
m_size         (0),
m_primitiveType(type),
m_usage        (usage)
...
////////////////////////////////////////////////////////////
Vertex3dBuffer::Vertex3dBuffer(const Vertex3dBuffer& copy) :
m_buffer       (0),
m_size         (0),
...
////////////////////////////////////////////////////////////
bool Vertex3dBuffer::create(std::size_t vertexCount)
{
    if (!isAvailable())
        return false;
    ...
    glCheck(GLEXT_glBufferData(GLEXT_GL_ARRAY_BUFFER, sizeof(Vertex3d) * vertexCount, 0, usageToGlEnum(m_usage)));
...
////////////////////////////////////////////////////////////
std::size_t Vertex3dBuffer::getVertexCount() const
{
    return m_size;
}
...
////////////////////////////////////////////////////////////
bool Vertex3dBuffer::update(const Vertex3d* vertices)
{
...
////////////////////////////////////////////////////////////
bool Vertex3dBuffer::update(const Vertex3d* vertices, std::size_t vertexCount, unsigned int offset)
{
    // Sanity checks
    if (!m_buffer)
        return false;
    ...
    glCheck(GLEXT_glBufferSubData(GLEXT_GL_ARRAY_BUFFER, sizeof(Vertex3d) * offset, sizeof(Vertex3d) * vertexCount, vertices));
...
////////////////////////////////////////////////////////////
bool Vertex3dBuffer::update(const Vertex3dBuffer& vertexBuffer)
{
    ...
    if (GLEXT_copy_buffer)
    {
        ...
        glCheck(GLEXT_glCopyBufferSubData(GLEXT_GL_COPY_READ_BUFFER, GLEXT_GL_COPY_WRITE_BUFFER, 0, 0, sizeof(Vertex3d) * vertexBuffer.m_size));
    ...
    glCheck(GLEXT_glBindBuffer(GLEXT_GL_ARRAY_BUFFER, m_buffer));
    glCheck(GLEXT_glBufferData(GLEXT_GL_ARRAY_BUFFER, sizeof(Vertex3d) * vertexBuffer.m_size, 0, usageToGlEnum(m_usage)));
    ...
    std::memcpy(destination, source, sizeof(Vertex3d) * vertexBuffer.m_size);
...
////////////////////////////////////////////////////////////
Vertex3dBuffer& Vertex3dBuffer::operator =(const Vertex3dBuffer& right)
{
    Vertex3dBuffer temp(right);
...
////////////////////////////////////////////////////////////
void Vertex3dBuffer::swap(Vertex3dBuffer& right)
{
...
////////////////////////////////////////////////////////////
unsigned int Vertex3dBuffer::getNativeHandle() const
{
    return m_buffer;
}
...
////////////////////////////////////////////////////////////
void Vertex3dBuffer::bind(const Vertex3dBuffer* vertexBuffer)
{
    if (!isAvailable())
        return;
...
////////////////////////////////////////////////////////////
void Vertex3dBuffer::setPrimitiveType(PrimitiveType type)
{
    m_primitiveType = type;
}
...
////////////////////////////////////////////////////////////
PrimitiveType Vertex3dBuffer::getPrimitiveType() const
{
...
////////////////////////////////////////////////////////////
void Vertex3dBuffer::setUsage(Vertex3dBuffer::Usage usage)
{
    m_usage = usage;
}
...
////////////////////////////////////////////////////////////
Vertex3dBuffer::Usage Vertex3dBuffer::getUsage() const
{
    return m_usage;
}
...
////////////////////////////////////////////////////////////
bool Vertex3dBuffer::isAvailable()
{
...
////////////////////////////////////////////////////////////
void Vertex3dBuffer::draw(RenderTarget& target, RenderStates states) const
{
    if (m_buffer && m_size)
